...
#ifndef __baofei_message_RegionMap_hpp__
#define __baofei_message_RegionMap_hpp__
...
class RegionMap
{
    ...
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(RegionMap, mapSign, name, editTime, createTime, isUseMap, isFormalMap, isSaveToFlash)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(RegionMap, mapSign, name, editTime, createTime, isUseMap, isFormalMap, isSaveToFlash)
#endif
    public:
        bool operator==(const RegionMap& other) const
        {
            return mapSign == other.mapSign && name == other.name && editTime == other.editTime && createTime == other.createTime && isUseMap == other.isUseMap && isFormalMap == other.isFormalMap && isSaveToFlash == other.isSaveToFlash;
        }
    public:
        /**
...
int RegionMap::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int RegionMap::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int RegionMap::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t RegionMap::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* RegionMap::getTypeName()
{
    return "RegionMap";
}

int RegionMap::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __int8_t_encode_array(buf, offset + pos, maxlen - pos, &this->isUseMap, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int RegionMap::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __int8_t_decode_array(buf, offset + pos, maxlen - pos, &this->isUseMap, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int RegionMap::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t RegionMap::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x7c351159e9995cb2LL;
