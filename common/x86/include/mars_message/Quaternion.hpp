...
#ifndef __mars_message_Quaternion_hpp__
#define __mars_message_Quaternion_hpp__
...
class Quaternion
{
    ...
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(Quaternion, w, x, y, z)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(Quaternion, w, x, y, z)
#endif
    public:
