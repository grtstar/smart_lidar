...
class Odometry
{
    ...
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(Odometry, timestampMs, pose, linearVelocity, angularVelocity)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(Odometry, timestampMs, pose, linearVelocity, angularVelocity)
#endif
    public:
        bool operator==(const Odometry& other) const
        {
            return timestampMs == other.timestampMs && pose == other.pose && linearVelocity == other.linearVelocity && angularVelocity == other.angularVelocity;
        }
    public:
        /**
