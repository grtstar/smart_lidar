...
class AppPartitionDivision
{
    ...
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(AppPartitionDivision, version, roomId, begin, end, ret)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(AppPartitionDivision, version, roomId, begin, end, ret)
#endif
    public:
        bool operator==(const AppPartitionDivision& other) const
        {
            return version == other.version && roomId == other.roomId && begin == other.begin && end == other.end && ret == other.ret;
        }
    public:
        /**
