...
#ifndef __mars_message_Pose_hpp__
#define __mars_message_Pose_hpp__
...
{
    public:
        mars_message::Vector3 pose;

        mars_message::Quaternion orientation;

#ifdef __NLOHMANN_JSON_CPP
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(Pose, pose, orientation)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(Pose, pose, orientation)
#endif
    public:
        bool operator==(const Pose& other) const
        {
            return pose == other.pose && orientation == other.orientation;
        }
    public:
        /**
...
uint64_t Pose::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x55798f1bab660288LL +
