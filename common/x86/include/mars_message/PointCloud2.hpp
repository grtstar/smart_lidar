...
#ifndef __mars_message_PointCloud2_hpp__
#define __mars_message_PointCloud2_hpp__
...
class PointCloud2
{
    ...
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(PointCloud2, timestampMs, scanTime, count, points, intensities)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(PointCloud2, timestampMs, scanTime, count, points, intensities)
#endif
    public:
        bool operator==(const PointCloud2& other) const
        {
            return timestampMs == other.timestampMs && scanTime == other.scanTime && count == other.count && points == other.points && intensities == other.intensities;
        }
    public:
        /**
...
uint64_t PointCloud2::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0xa70744f80b87fabdLL +
