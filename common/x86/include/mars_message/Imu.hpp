...
class Imu
{
    ...
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(Imu, timestampMs, orientation, orientationCovariance, angularVelocity, angularVelocityCovariance, linearAcceleraion, linearAcceleraionCovariance)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(Imu, timestampMs, orientation, orientationCovariance, angularVelocity, angularVelocityCovariance, linearAcceleraion, linearAcceleraionCovariance)
#endif
    public:
        bool operator==(const Imu& other) const
        {
            return timestampMs == other.timestampMs && orientation == other.orientation && orientationCovariance == other.orientationCovariance && angularVelocity == other.angularVelocity && angularVelocityCovariance == other.angularVelocityCovariance && linearAcceleraion == other.linearAcceleraion && linearAcceleraionCovariance == other.linearAcceleraionCovariance;
        }
    public:
        /**
