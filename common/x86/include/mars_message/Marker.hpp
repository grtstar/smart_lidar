...
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(Marker, timestampMs, ns, id, type, action, pose, scale, color, lifetime, frame_locked, pointCount, points, colors, text, mesh_resource, mesh_use_embeded_materials)
#endif
    public:
