...
#ifndef __mars_message_PointCloud_hpp__
#define __mars_message_PointCloud_hpp__
...
class PointCloud
{
    ...
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(PointCloud, timestampMs, count, points, intensities)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(PointCloud, timestampMs, count, points, intensities)
#endif
    public:
        bool operator==(const PointCloud& other) const
        {
            return timestampMs == other.timestampMs && count == other.count && points == other.points && intensities == other.intensities;
        }
    public:
        /**
...
uint64_t PointCloud::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0xfa2a3d35529337a9LL +
