...
#ifndef __mars_message_Twist_hpp__
#define __mars_message_Twist_hpp__
...
class Twist
{
    ...
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(Twist, timestampMs, linearVelocity, angularVelocity)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(Twist, timestampMs, linearVelocity, angularVelocity)
#endif
    public:
        bool operator==(const Twist& other) const
        {
            return timestampMs == other.timestampMs && linearVelocity == other.linearVelocity && angularVelocity == other.angularVelocity;
        }
    public:
        /**
...
uint64_t Twist::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x837920f58e4c741aLL +
