...
class OverloadConfig(object):
    ...
    def from_dict(self, j):
        self.wheel = j["wheel"]
        self.sideBrush = j["sideBrush"]
        self.mainBrush = j["mainBrush"]
        self.rollBrush = j["rollBrush"]
        self.liftMotor = j["liftMotor"]
        self.waterPump = j["waterPump"]
        self.sewagePump = j["sewagePump"]
        self.airPump = j["airPump"]
        self.fanPump = j["fanPump"]

    def to_dict(self):
        j = {}
        j["wheel"] = self.wheel
        j["sideBrush"] = self.sideBrush
        j["mainBrush"] = self.mainBrush
        j["rollBrush"] = self.rollBrush
        j["liftMotor"] = self.liftMotor
        j["waterPump"] = self.waterPump
        j["sewagePump"] = self.sewagePump
        j["airPump"] = self.airPump
        j["fanPump"] = self.fanPump
        return j
