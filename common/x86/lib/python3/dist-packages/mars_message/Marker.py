...
class Marker(object):
    ...
    def from_dict(self, j):
        ...
        self.scale.from_dict(j["scale"])
        self.color.from_dict(j["color"])
        self.lifetime = j["lifetime"]
        self.frame_locked = j["frame_locked"]
        self.pointCount = j["pointCount"]
        self.points = [x.from_dict() for x in j["points"]]
        self.colors = [x.from_dict() for x in j["colors"]]
        self.text = j["text"]
        self.mesh_resource = j["mesh_resource"]
        self.mesh_use_embeded_materials = j["mesh_use_embeded_materials"]
    ...
    def to_dict(self):
        ...
        j["scale"] = self.scale.to_dict()
        j["color"] = self.color.to_dict()
        j["lifetime"] = self.lifetime
        j["frame_locked"] = self.frame_locked
        j["pointCount"] = self.pointCount
        j["points"] = [x.to_dict() for x in self.points]
        j["colors"] = [x.to_dict() for x in self.colors]
        j["text"] = self.text
        j["mesh_resource"] = self.mesh_resource
        j["mesh_use_embeded_materials"] = self.mesh_use_embeded_materials
        return j
