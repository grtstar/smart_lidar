...
class SweeperStatus(object):
    ...
    def from_dict(self, j):
        self.mcuStatus.from_dict(j["mcuStatus"])
        self.runningState = j["runningState"]
        self.pauseStatus = j["pauseStatus"]
        self.chargeStatus = j["chargeStatus"]
        self.cleanMode = j["cleanMode"]
        self.cleanStatus = j["cleanStatus"]
        self.cleanTime = j["cleanTime"]
        self.cleanArea = j["cleanArea"]
        self.suctionPower = j["suctionPower"]
        self.cistern = j["cistern"]
        self.wipe = j["wipe"]
        self.manualDirection = j["manualDirection"]
        self.edgeBrushLife = j["edgeBrushLife"]
        self.rollBrushLife = j["rollBrushLife"]
        self.filterLife = j["filterLife"]
        self.ragLife = j["ragLife"]
        self.donotDisturb = j["donotDisturb"]
        self.volume = j["volume"]
        self.cleanAreaTotal = j["cleanAreaTotal"]
        self.cleanCountTotal = j["cleanCountTotal"]
        self.cleanTimeTotal = j["cleanTimeTotal"]
        self.language = j["language"]
        self.dustCollectionNum = j["dustCollectionNum"]
        self.dustCollectionSwitch = j["dustCollectionSwitch"]
        self.mapState = j["mapState"]
        self.esimateArea = j["esimateArea"]
        self.carpetCleanPefer = j["carpetCleanPefer"]
        self.autoBoost = j["autoBoost"]
        self.childLock = j["childLock"]
        self.yMop = j["yMop"]

    def to_dict(self):
        j = {}
        j["mcuStatus"] = self.mcuStatus.to_dict()
        j["runningState"] = self.runningState
        j["pauseStatus"] = self.pauseStatus
        j["chargeStatus"] = self.chargeStatus
        j["cleanMode"] = self.cleanMode
        j["cleanStatus"] = self.cleanStatus
        j["cleanTime"] = self.cleanTime
        j["cleanArea"] = self.cleanArea
        j["suctionPower"] = self.suctionPower
        j["cistern"] = self.cistern
        j["wipe"] = self.wipe
        j["manualDirection"] = self.manualDirection
        j["edgeBrushLife"] = self.edgeBrushLife
        j["rollBrushLife"] = self.rollBrushLife
        j["filterLife"] = self.filterLife
        j["ragLife"] = self.ragLife
        j["donotDisturb"] = self.donotDisturb
        j["volume"] = self.volume
        j["cleanAreaTotal"] = self.cleanAreaTotal
        j["cleanCountTotal"] = self.cleanCountTotal
        j["cleanTimeTotal"] = self.cleanTimeTotal
        j["language"] = self.language
        j["dustCollectionNum"] = self.dustCollectionNum
        j["dustCollectionSwitch"] = self.dustCollectionSwitch
        j["mapState"] = self.mapState
        j["esimateArea"] = self.esimateArea
        j["carpetCleanPefer"] = self.carpetCleanPefer
        j["autoBoost"] = self.autoBoost
        j["childLock"] = self.childLock
        j["yMop"] = self.yMop
        return j
