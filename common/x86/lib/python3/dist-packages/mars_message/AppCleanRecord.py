...
class AppCleanRecord(object):
    ...
    def from_dict(self, j):
        self.recordId = j["recordId"]
        self.cleanTimeSecond = j["cleanTimeSecond"]
        self.cleanArea = j["cleanArea"]
        self.cleanMode = j["cleanMode"]
        self.cleanMethod = j["cleanMethod"]
        self.finishResult = j["finishResult"]
        self.startReason = j["startReason"]

    def to_dict(self):
        j = {}
        j["recordId"] = self.recordId
        j["cleanTimeSecond"] = self.cleanTimeSecond
        j["cleanArea"] = self.cleanArea
        j["cleanMode"] = self.cleanMode
        j["cleanMethod"] = self.cleanMethod
        j["finishResult"] = self.finishResult
        j["startReason"] = self.startReason
        return j
