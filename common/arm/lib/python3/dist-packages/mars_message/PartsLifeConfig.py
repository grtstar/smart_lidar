...
class PartsLifeConfig(object):
    ...
    def from_dict(self, j):
        self.sideBrushLife = j["sideBrushLife"]
        self.sideBrushLifeMax = j["sideBrushLifeMax"]
        self.mainBrushLife = j["mainBrushLife"]
        self.mainBrushLifeMax = j["mainBrushLifeMax"]
        self.rollBrushLife = j["rollBrushLife"]
        self.rollBrushLifeMax = j["rollBrushLifeMax"]
        self.hiparLife = j["hiparLife"]
        self.hiparLifeMax = j["hiparLifeMax"]
        self.ragLife = j["ragLife"]
        self.ragLifeMax = j["ragLifeMax"]

    def to_dict(self):
        j = {}
        j["sideBrushLife"] = self.sideBrushLife
        j["sideBrushLifeMax"] = self.sideBrushLifeMax
        j["mainBrushLife"] = self.mainBrushLife
        j["mainBrushLifeMax"] = self.mainBrushLifeMax
        j["rollBrushLife"] = self.rollBrushLife
        j["rollBrushLifeMax"] = self.rollBrushLifeMax
        j["hiparLife"] = self.hiparLife
        j["hiparLifeMax"] = self.hiparLifeMax
        j["ragLife"] = self.ragLife
        j["ragLifeMax"] = self.ragLifeMax
        return j
