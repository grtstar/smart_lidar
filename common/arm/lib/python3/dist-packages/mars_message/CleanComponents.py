...
class CleanComponents(object):
    ...
    def from_dict(self, j):
        self.sideBrush.from_dict(j["sideBrush"])
        self.mainBrush.from_dict(j["mainBrush"])
        self.roller.from_dict(j["roller"])
        self.waterTank.from_dict(j["waterTank"])
        self.mop.from_dict(j["mop"])
        self.waterPump.from_dict(j["waterPump"])
        self.fan.from_dict(j["fan"])

    def to_dict(self):
        j = {}
        j["sideBrush"] = self.sideBrush.to_dict()
        j["mainBrush"] = self.mainBrush.to_dict()
        j["roller"] = self.roller.to_dict()
        j["waterTank"] = self.waterTank.to_dict()
        j["mop"] = self.mop.to_dict()
        j["waterPump"] = self.waterPump.to_dict()
        j["fan"] = self.fan.to_dict()
        return j
