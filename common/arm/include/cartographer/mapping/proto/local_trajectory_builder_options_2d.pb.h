...
class LocalTrajectoryBuilderOptions2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D) */ {
 public:
  ...
  bool has_in_location_inserter() const;
  void clear_in_location_inserter();
  static const int kInLocationInserterFieldNumber = 22;
  const ::cartographer::mapping::proto::InLocationInserterOptions& in_location_inserter() const;
  ::cartographer::mapping::proto::InLocationInserterOptions* mutable_in_location_inserter();
  ::cartographer::mapping::proto::InLocationInserterOptions* release_in_location_inserter();
  void set_allocated_in_location_inserter(::cartographer::mapping::proto::InLocationInserterOptions* in_location_inserter);
 ...
 private:
  ...
  ::cartographer::mapping::proto::InLocationInserterOptions* in_location_inserter_;
  float min_z_;
  float max_z_;
...
// .cartographer.mapping.proto.InLocationInserterOptions in_location_inserter = 22;
inline bool LocalTrajectoryBuilderOptions2D::has_in_location_inserter() const {
  return this != internal_default_instance() && in_location_inserter_ != NULL;
}
inline void LocalTrajectoryBuilderOptions2D::clear_in_location_inserter() {
  if (GetArenaNoVirtual() == NULL && in_location_inserter_ != NULL) delete in_location_inserter_;
  in_location_inserter_ = NULL;
}
inline const ::cartographer::mapping::proto::InLocationInserterOptions& LocalTrajectoryBuilderOptions2D::in_location_inserter() const {
...
inline ::cartographer::mapping::proto::InLocationInserterOptions* LocalTrajectoryBuilderOptions2D::mutable_in_location_inserter() {
...
inline ::cartographer::mapping::proto::InLocationInserterOptions* LocalTrajectoryBuilderOptions2D::release_in_location_inserter() {
...
inline void LocalTrajectoryBuilderOptions2D::set_allocated_in_location_inserter(::cartographer::mapping::proto::InLocationInserterOptions* in_location_inserter) {
